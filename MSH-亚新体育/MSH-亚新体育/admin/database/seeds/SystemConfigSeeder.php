...
//            ['name' => 'redbag_max_money','title' => '红包最大金额','config_group' => 'activity','type' => 'number','value' => '10','is_open' => '1',],
 //           ['name' => 'redbag_day_times','title' => '每日抢红包次数','config_group' => 'activity','type' => 'number','value' => '3','is_open' => '1',],
            ...
            ['name' => 'is_daily_bonus_auto','title' => '签到是否自动领奖','config_group' => 'activity','type' => 'boolean','value' => '1','link_html' => '<a href="javascript:;" data-url="/admin/dailybonuses" data-title="签到设置" class="js-create-tab multitabs">【打开签到设置】</a>','is_open' => '1',],
            ...
            ['name' => 'site_slogan','title' => '网站副logo','config_group' => 'system','type' => 'picture','value' => env('APP_URL').'/storage/uploads/config/202005/24/config_1590301172_yKkvwoooIg.png','is_open' => '1','description' => 'APPlogo',],
...
//            ['name' => 'max_transfer','title' => '最高提款金额','config_group' => 'drawing','type' => 'number','value' => '10000','is_open' => '1',],
        ...
        */
        ...
        $params = [
            ...
            ['name' => 'vip1_lang_fields','title' => '前端开启语种','config_group' => 'language','type' => 'text','value' => '{"zh_cn":"中文","zh_hk":"繁體中文","en":"English","th":"ภาษาไทย","vi":"ViệtName"}','lang' => 'common'],
        ];
