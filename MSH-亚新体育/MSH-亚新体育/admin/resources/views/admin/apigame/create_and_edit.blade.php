            ...
            <form method="post" class="form-horizontal"
                ...
                @foreach(config('platform.language_type') as $k => $v)
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" required class="form-control" name="lang_json[{{ $k }}]" placeholder="请输入游戏标题[{{$v}}]"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select name="game_type" id="game_type" class="form-control js_select2">
                            <option value="">@lang('res.common.select_default')</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <span class="help-block">gameCode":0后面数字是子游戏代码，【电竞】在体育类目"gameType":7</span>
                    </div>
                </div>
...
<script>
    $(function () {
        ...
        $('#game_type').change(function() {
            ...
            switch(gameType) {
                case '1': // 真人
                    paramsValue = '{"gameCode":0,"gameType":1}';
                    break;
                case '2': // 捕鱼
                    paramsValue = '{"gameCode":0,"gameType":2}';
                    break;
                case '3': // 电子
                    paramsValue = '{"gameCode":0,"gameType":3}';
                    break;
                case '4': // 彩票
                    paramsValue = '{"gameCode":0,"gameType":4}';
                    break;
                case '5': // 体育
                    paramsValue = '{"gameCode":0,"gameType":5}';
                    break;
                case '6': // 棋牌
                    paramsValue = '{"gameCode":0,"gameType":6}';
                    break;
            }
            
            if (paramsValue) {
                $('#params').val(paramsValue);
            }
        });
