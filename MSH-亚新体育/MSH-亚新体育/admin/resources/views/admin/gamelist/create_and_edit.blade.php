        ...
        <div class="card-body">
            ...
            <form method="post" class="form-horizontal"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="game_code"
                            value="{{ $isUpdated?$model->game_code:"0" }}" @if(!$isUpdated) required @endif>
                    </div>
                    <div class="col-sm-4">
                        <span class="help-block">子游戏代码，0为游戏大厅</span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="param_remark" id="param_remark"
...
<script>
    $(function () {
        ...
        // 设置参数补充字段默认值为 {"gameType":3}
        if (!$('#param_remark').val()) {
            $('#param_remark').val('{"gameType":3}');
        }
        ...
        $('#game_type').change(function() {
            ...
            switch(gameType) {
                case '1': // 真人
                    paramValue = '{"gameType":1}';
                    break;
                case '2': // 捕鱼
                    paramValue = '{"gameType":2}';
                    break;
                case '3': // 电子
                    paramValue = '{"gameType":3}';
                    break;
                case '4': // 彩票
                    paramValue = '{"gameType":4}';
                    break;
                case '5': // 体育
                    paramValue = '{"gameType":5}';
                    break;
                case '6': // 棋牌
                    paramValue = '{"gameType":6}';
                    break;
            }
            
            if (paramValue) {
                $('#param_remark').val(paramValue);
            }
        });
    });
